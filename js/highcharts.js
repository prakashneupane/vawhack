...
(function () {
    ...
    function L(a, b) {
        if (Da && b && b.opacity !== x) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        v(a.style, b)
    }
    ...
    function Ea(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = [];
            ...
            if (d) {
                ...
                for (h = 0; h <
                    i; h++) e = e[g[h]];
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = N.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Na(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = Ua(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Ab(a, b, c, d) {
        ...
        if (r(b)) {
            j >= E[jb] &&
            (i.setMilliseconds(0), i.setSeconds(j >= E[Va] ? 0 : k * T(i.getSeconds() / k)));
            if (j >= E[Va]) i[Bb](j >= E[Oa] ? 0 : k * T(i[kb]() / k));
            if (j >= E[Oa]) i[Cb](j >= E[oa] ? 0 : k * T(i[lb]() / k));
            if (j >= E[oa]) i[mb](j >= E[Pa] ? 1 : k * T(i[Qa]() / k));
            j >= E[Pa] && (i[Db](j >= E[va] ? 0 : k * T(i[Xa]() / k)), h = i[Ya]());
            j >= E[va] && (h -= h % k, i[Eb](h));
            if (j === E[Wa]) i[mb](i[Qa]() - i[nb]() + o(d, 1));
            b = 1;
            h = i[Ya]();
            for (var d = i.getTime(), m = i[Xa](), l = i[Qa](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === E[va] ? d = Za(h + b * k, 0) : j === E[Pa] ? d = Za(h, m + b * k) : !g && (j ===
                E[oa] || j === E[Wa]) ? d = Za(h, m, l + b * k * (j === E[oa] ? 1 : 7)) : (j <= E[Oa] && d % E[oa] === i && (f[d] = oa), d += j * k), b++;
            e.push(d)
        }
        e.info = v(a, {
                higherRanks: f,
    ...
    function Hb() {
        ...
        Za = a ? Date.UTC : function (a, b, c, g, h, i) {
            return (new Date(a, b, o(c, 1), o(g, 0), o(h,
                        0), o(i, 0))).getTime()
        };
        kb = b + "Minutes";
        lb = b + "Hours";
    ...
    var x, z = document,
        ...
        Jb = O.opera,
        Da = /msie/i.test(ya) && !Jb,
        cb = z.documentMode === 8,
        db = /AppleWebKit/.test(ya),
        eb = /Firefox/.test(ya),
        Kb = /(Mobile|Android|Windows Phone)/.test(ya),
        sa = "http://www.w3.org/2000/svg",
        Z = !! z.createElementNS && !! z.createElementNS(sa, "svg").createSVGRect,
        Rb = eb && parseInt(ya.split("Firefox/")[1], 10) < 4,
        $ = !Z && !Da && !! z.createElement("canvas").getContext,
        Sa, fb = z.documentElement.ontouchstart !== x,
        Lb = {}, tb = 0,
        $a, N, Ua, xa, ub, E, ta = function () {}, za = [],
        wa = "div",
        S = "none",
        Mb = "rgba(192,192,192," + (Z ? 1.0E-4 : 0.002) + ")",
        zb = "millisecond",
        jb = "second",
        Va = "minute",
        Oa = "hour",
        ...
        va = "year",
        Nb = "stroke-width",
        Za, kb, lb, nb, Qa, Xa, Ya, Bb, Cb, mb, Db, Eb, aa = {};
    ...
    E = function () {
        ...
        1, jb, 1E3, Va, 6E4, Oa, 36E5, oa, 864E5, Wa, 6048E5, Pa, 26784E5, va, 31556952E3);
    ub = {
        init: function (a, b, c) {
            var b = b || "",
                d = a.shift,
            ...
            a.shift = 0;
            if (b.length)
                for (a = c.length; b.length < a;) d = [].concat(b).splice(b.length - f, f), e && (d[f -
            ...
            init: function (b) {
                ...
                a.each(["cur", "_default", "width", "height",
                        ...
                        (k = e[b]) && (e[b] = function (c) {
                            c = a ? c : this;
                            m = c.elem;
                            return m.attr ? m.attr(c.prop, b === "cur" ? x : c.now) : k.apply(this, arguments)
                        })
                    });
                e = function (a) {
                    var c = a.elem,
                ...
                a.fn.highcharts = function () {
                    ...
                    c = b[0];
                    if (c !== x) c.chart = c.chart || {}, c.chart.renderTo = this[0], new Highcharts[a](c, b[1]), d = this;
                    c === x && (d = za[A(this[0], "data-highcharts-chart")]);
                    return d
                }
            },
        ...
        return {
            ...
            brighten: function (a) {
                if (d) n(d, function (b) {
                    ...
                    var c;
                    for (c = 0; c < 3; c++) b[c] += u(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
                }
                return this
            },
            rgba: b,
    ...
    ra.prototype = {
                ...
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "stroke-width" || c === "stroke") {
                            this[c] = d;
                            if (this.stroke && this["stroke-width"]) A(g, "stroke", this.stroke), A(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0;
        ...
        css: function (a) {
            ...
            $ && b && delete a.width;
            if (Da && !Z) b && delete a.width, L(this.element, a);
            else {
        ...
        htmlUpdateTransform: function () {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (G !== this.cTT) {
                        if (r(j)) a.isSVG ? (B = Da ? "-ms-transform" : db ? "-webkit-transform" : eb ? "MozTransform" : Jb ? "-o-transform" : "", k[B] = k.transform = "rotate(" + j + "deg)") : (p = j * bb, s = Y(p), p = ca(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", s, ", M12=", -p, ", M21=", p, ", M22=", s, ", sizingMethod='auto expand')"].join("") : S), L(b, k);
                        k =
        ...
        updateTransform: function () {
            ...
            (r(c) || r(d)) && g.push("scale(" + o(c, 1) + " " + o(d, 1) + ")");
            g.length && A(this.element, "transform", g.join(" "))
        },
        toFront: function () {
            var a = this.element;
        ...
        getBBox: function () {
            ...
            if (!a) {
                if (c.namespaceURI === sa || b.forExport) {
                    ...
                    if (d) a.width =
                        Q(c * ca(f)) + Q(b * Y(f)), a.height = Q(c * Y(f)) + Q(b * ca(f))
                }
                this.bBox = a
            }
            return a
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) A(f,
                        "height", q(A(f, "height") - h, 0)), f.cutHeight = h;
    ...
    Aa.prototype = {
        ...
        buildText: function (a) {
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                        "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = A(b, "x"), j = a.styles, k = j && j.width && u(j.width), m = j && j.lineHeight, l = f.length; l--;) b.removeChild(f[l]);
                ...
                n(l, function (e) {
                    if (e !== "" || l.length === 1) {
                        var p = {}, n = z.createElementNS(sa, "tspan"),
                            q;
                        g.test(e) && (q =
                            e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), A(n, "style", q));
                        ...
                        if (k)
                            for (var e = e.replace(/([^\^])-/g,
                                    "$1- ").split(" "), r, t = []; e.length || t.length;) delete a.bBox, r = a.getBBox().width, p = r > k, !p || e.length === 1 ? (e = t, t = [], e.length && (n = z.createElementNS(sa, "tspan"), A(n, {
                                            dy: m || 16,
                                            x: i
        ...
        color: function (a, b, c) {
            ...
            if (g) {
                ...
                g === "radialGradient" && b && !r(c.gradientUnits) && (c = y(c, {
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            function j() {
                var a, b;
                a = o.element.style;
                w = (La === void 0 || xb === void 0 || s.styles.textAlign) && o.getBBox();
                s.width = (La || w.width || 0) + 2 * q + hb;
                s.height = (xb || w.height || 0) + 2 * q;
                A = q + p.fontMetrics(a &&
                    a.fontSize).b;
                if (z) {
                    if (!B) a = t(-G * q), b = h ? -A : 0, s.box = B = d ? p.symbol(d, a, b, s.width, s.height) : p.rect(a, b, s.width, s.height, 0, u[Nb]), B.add(s);
                    B.isImg || B.attr(y({
                                width: s.width,
                                height: s.height
                            }, u));
        ...
        Highcharts.VMLElement = F = {
            ...
            attr: function (a, b) {
                var c,
                    ...
                    s = this;
                fa(a) && r(b) && (c = a, a = {}, a[c] = b);
                if (fa(a)) c = a, s = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
                else
                    for (c in a)
                        if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), l = !0;
                                ...
                                else if (l[e] = d[e], d.isArc && (d[e] === "wa" || d[e] === "at")) o = d[e] === "wa" ? 1 : -1, l[e + 5] === l[e + 7] && (l[e + 7] -= o), l[e + 6] === l[e + 8] && (l[e + 8] -= o);
                                d = l.join(" ") || "x";
                                f.path = d;
                                if (m)
                            ...
                            else if (c === "stroke-width" || c === "strokeWidth") f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ca(d) && (d += "px");
                            ...
                            else if (h === "shape" && c === "rotation") this[c] = d, f.style.left = -t(ca(d * bb) + 1) + "px", f.style.top = t(Y(d * bb)) + "px";
        ...
        var na = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - I.atan((l - a) / (p - c)) * 180 / Ja) + '"', x();
                        else {
                            var j = l.r,
                                v = j * 2,
                                P = j * 2,
                                ...
                                y = b.radialReference,
                                u, j = function () {
                                    y && (u = d.getBBox(), H += (y[0] - u.x) / u.width -
                                        0.5, C += (y[1] - u.y) / u.height - 0.5, v *= y[2] / u.width, P *= y[2] / u.height);
            ...
            symbols: {
                ...
                rect: function (a, b, c, d, e) {
                    var f = a + c,
                        g = b + d,
                        h;
                    !r(e) || !e.r ? f = Aa.prototype.symbols.square.apply(0,
                        arguments) : (h = K(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                    return f
                }
            }
        };
    ...
    Ia.prototype = {
        addLabel: function () {
            var a = this.axis,
                ...
                i = i.info,
                m;
            a.isDatetimeAxis && i && (m = b.dateTimeLabelFormats[i.higherRanks[g] ||
                i.unitName]);
            this.isFirst = j;
            this.isLast = k;
            ...
            if (r(e)) e && e.attr({
                ...
                if (Ca(h.rotation)) d.rotation = h.rotation;
        ...
        getLabelSize: function () {
            var a = this.label,
                b = this.axis;
            return a ? (this.labelBBox = a.getBBox())[b.horiz ?
            "height" : "width"] : 0
        },
        ...
        handleOverflow: function (a, b) {
            ...
            if (f || g) {
                ...
                f && !i || g && i ? h + m < e && (h = e - m, d && h + k > j && (c = !1)) : h + k > l && (h = l - k, d &&
                    h + m < j && (c = !1));
                b.x = h
            }
            return c
        ...
        render: function (a, b, c) {
            ...
            if (i && !isNaN(H)) i.xy = P = this.getLabelPosition(H, P, i, g, k, u, a, t), this.isFirst && !o(e.showFirstLabel, 1) || this.isLast && !o(e.showLastLabel, 1) ? v = !1 : !y && g && k.overflow === "justify" && !this.handleOverflow(a, P) && (v = !1), t && a % t && (v = !1), v && !isNaN(P.y) ? (P.opacity = c, i[this.isNew ? "attr" : "animate"](P), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function () {
            Ga(this, this.axis)
        }
    ...
    ab.prototype = {
        ...
        setOptions: function (a) {
            this.options = y(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions,
                    this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions
                ][this.side], y(N[this.isXAxis ? "xAxis" : "yAxis"], a))
        },
        update: function (a, b) {
            var c = this.chart,
                a = c.options[this.xOrY + "Axis"][this.options.index] = y(this.userOptions, a);
            this.destroy();
            this._addedPlotLB = !1;
            this.init(c, a);
            c.isDirtyBox = !0;
        ...
        defaultLabelFormatter: function () {
            ...
            if (h) g = Ea(h, this);
                ...
                for (; f-- && g === x;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Na(b / c, -1) + e[f]);
            g === x && (g = b >= 1E3 ? Na(b, 0) : Na(b, -1));
            return g
        },
        getSeriesExtremes: function () {
            ...
            n(a.series, function (g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (j = g.xData, j.length) a.dataMin = K(o(a.dataMin, j[0]), Fa(j)), a.dataMax = q(o(a.dataMax, j[0]), pa(j))
                    } else {
                        ...
                        if (k) s =
                            j.stack, p = g.type + o(s, ""), n = "-" + p, g.stackKey = p, m = d[p] || [], d[p] = m, l = e[n] || [], e[n] = l;
                        ...
                        for (h = 0; h < v; h++) {
                            w = j[h];
                            G = B[h];
                            if (k) H = (P = G < t) ? l : m, C = P ? n : p, r(H[w]) ? (H[w] = ia(H[w] + G), G = [G, H[w]]) : H[w] = G, c[C] || (c[C] = {}), c[C][w] || (c[C][w] = new Ib(a, a.options.stackLabels, P, w, s, k)), c[C][w].setTotal(H[w]), c[C][w].touched = f;
                            if (G !== null && G !== x && (!a.isLog || G.length || G > 0))
                                if (E && (G = g.modifyValue(G)), g.getExtremesFromAll || A || (j[h + 1] || w) >=
                                    z.min && (j[h - 1] || w) <= z.max)
                                    if (w = G.length)
                                        for (; w--;) G[w] !== null && (u[y++] = G[w]);
                                    else u[y++] = G
                        }
                        if (!a.usePercentage && u.length) g.dataMin = k = Fa(u), g.dataMax = g = pa(u), a.dataMin = K(o(a.dataMin, k), k), a.dataMax = q(o(a.dataMax, g), g);
                        if (r(t))
        ...
        getLogTickPositions: function (a, b, c, d) {
            ...
            if (a >= 0.5) a = t(a), g = this.getLinearTickPositions(a, b, c);
                ...
                for (var f = T(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                    i = e.length;
                    for (h = 0; h < i && !m; h++) j = ka(da(f) * e[h]), j > b && (!d || k <= c) && g.push(k),
                    k > c && (m = !0), k = j
            } else if (b = da(b), c = da(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ib(a, null, I.pow(10, T(I.log(a) / I.LN10))), g = Ka(this.getLinearTickPositions(a, b, c), ka), !d) this._minorAutoInterval = a / 5;
        ...
        getMinorTickPositions: function () {
            ...
            } else if (this.isDatetimeAxis && a.minorTickInterval === "auto") d = d.concat(Ab(yb(c), this.min, this.max, a.startOfWeek)), d[0] < this.min && d.shift();
            else
        ...
        setAxisTranslation: function (a) {
            ...
            if (this.isXAxis) g ? (e = g.minPointOffset, f = g.pointRangePadding) :
                ...
                }), g = this.ordinalSlope ? this.ordinalSlope / d : 1, this.minPointOffset = e *= g, this.pointRangePadding = f *= g, this.pointRange = K(c, b), this.closestPointRange = d;
        ...
        setTickPositions: function (a) {
            ...
            if (e)!a && K(b.min, o(b.dataMin, b.min)) <=
                0 && qa(10, 1), b.min = ia(ka(b.min)), b.max = ia(ka(b.max));
            ...
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !m && p === b.linkedParent.options.tickPixelInterval ?
                b.linkedParent.tickInterval : o(m, s ? 1 : (b.max - b.min) * p / (b.len || 1));
            ...
            if (!f && !e && (a = I.pow(10, T(I.log(b.tickInterval) / I.LN10)), !m)) b.tickInterval = ib(b.tickInterval, null, a, d);
            ...
            if (!i) i = f ? (b.getNonLinearTimeTicks || Ab)(yb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i;
            if (!h) e = i[0], f = i[i.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && i.shift(), d.endOnTick ?
                b.max = f : b.max + h < f && i.pop(), i.length === 1 && (b.min -= 0.001, b.max += 0.001)
        },
        ...
        setScale: function () {
            ...
            if (e || d || this.isLinked || this.forceRedraw || this.userMin !==
                this.oldUserMin || this.userMax !== this.oldUserMax)
        ...
        zoom: function (a, b) {
            this.allowZoomOutside || (a <= this.dataMin && (a = x), b >= this.dataMax && (b = x));
        ...
        getOffset: function () {
            ...
            if (b || a.isLinked) n(e, function (b) {
                ...
                for (v in f) f[v].destroy(), delete f[v]; if (p && p.text && p.enabled !== !1) {
                if (!a.axisTitle) a.axisTitle = c.text(p.text, 0, 0,
                    p.useHTML).attr({
                        zIndex: 7,
        ...
        render: function () {
            ...
            if (B || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function (b) {
                            ...
                            k[b].render(null, !1, 1)
                                ...
                                if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new Ia(a, b)), w && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
                            }), s && a.min === 0 && (j[-1] || (j[-1] = new Ia(a, -1, null, !0)), j[-1].render(-1))), p && n(g, function (b, c) {
                            if (c % 2 === 0 && b < a.max) m[b] || (m[b] = new ob(a)),
                            t = b + s, v = g[c + 1] !== x ? g[c + 1] + s : a.max, m[b].options = {
                                from: e ? da(t) : t,
                                to: e ? da(v) : v,
                                color: p
            ...
            n([j, k, m], function (a) {
                ...
                a === m || !b.hasRendered || !f ? g() : f && setTimeout(g,
                    f)
            });
    ...
    pb.prototype = {
        ...
        move: function (a, b, c, d) {
            ...
            e.label.attr(f);
            if (g && (Q(a - f.x) > 1 || Q(b - f.y) > 1)) clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function () {
                e && e.move(a, b, c, d)
            }, 32)
        },
        hide: function () {
            var a = this,
                b;
            if (!this.isHidden) b =
                this.chart.hoverPoints, this.hideTimer = setTimeout(function () {
                    a.label.fadeOut();
                    a.isHidden = !0
        ...
        getAnchor: function (a, b) {
            var c, d = this.chart,
                ...
                i, a = ha(a);
            c = a[0].tooltipPos;
            this.followPointer && b && (b.chartX === x && (b = d.pointer.normalize(b)), c = [b.chartX - d.plotLeft, b.chartY - f]);
            c || (n(a, function (a) {
                        i = a.series.yAxis;
                        g +=
                            a.plotX;
        ...
        refresh: function (a, b) {
            ...
            j === !1 || !h ? this.hide() : (this.isHidden && (Ta(d), d.attr("opacity",
                        1).show()), d.attr({
                        text: j
    ...
    qb.prototype = {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length &&
                        (b = c[i].tooltipPoints[k], b.series)) b._dist = Q(k - b.clientX), j = K(j, b._dist), e.push(b);
        ...
        scaleGroups: function (a, b) {
            ...
            n(c.series, function (d) {
                d.xAxis.zoomEnabled && (d.group.attr(a), d.markerGroup && (d.markerGroup.attr(a), d.markerGroup.clip(b ? c.clipRect : null)), d.dataLabelsGroup && d.dataLabelsGroup.attr(a))
            });
        ...
        pinch: function (a) {
            var b =
                ...
                c = b.chart,
                d = b.pinchDown,
                e = c.tooltip.options.followTouchMove,
                f = a.touches,
                g = f.length,
                h = b.lastValidTouch,
                ...
                m = b.selectionMarker,
                l = {}, p = {};
            a.type === "touchstart" && e && (b.inClass(a.target, "highcharts-tracker") ? (!c.runTrackerClick || g > 1) && a.preventDefault() : (!c.runChartClick || g > 1) && a.preventDefault());
            Ka(f, function (a) {
            ...
            if (a.type === "touchstart") n(f, function (a, b) {
                ...
                d[1].chartX
            ], h.y = [d[0].chartY, d[1] && d[1].chartY], n(c.axes, function (a) {
                if (a.zoomEnabled) {
        ...
        drag: function (a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX ||
                        this.zoomY) && k && !this.selectionMarker) this.selectionMarker = b.renderer.rect(g, h, e ? 1 : i, f ? 1 : j, 0).attr({
        ...
        drop: function (a) {
                ...
                if (this.hasDragged || c) n(b.axes, function (a) {
                    if (a.zoomEnabled) {
                        var b = a.horiz,
                            c = a.minPixelPadding,
                            m = a.toValue((b ? f : g) + c),
                            b = a.toValue((b ? f + e.width : g + e.height) - c);
            ...
            if (b) L(b.container, {
                    cursor: b._cursor
                }), b.cancelClick = this.hasDragged, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
        },
        ...
        onTrackerMouseOut: function (a) {
            ...
            if (b && !b.options.stickyTracking && !this.inClass(a.toElement ||
                    a.relatedTarget, "highcharts-tooltip")) b.onMouseOut()
        },
        onContainerClick: function (a) {
            ...
            if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, v(c, {
                        ...
                        pageY: g.top + e + (f ? b.plotHeight - h : i)
                            ...
                            point: c
                        })), c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY -
                    e) && D(b, "click", a))
        },
        ...
        destroy: function () {
            ...
            n(a._events, function (b) {
                b[1].indexOf("on") ===
                    0 ? b[0][b[1]] = null : ba(b[0], b[1], a["_" + b[2]])
            });
            delete a._events;
    ...
    rb.prototype = {
        init: function (a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = u(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function () {
        ...
        colorizeItem: function (a, b) {
            ...
            if (f) {
                if (g)
                    for (j in g = a.convertAttribs(g), g) d = g[j], d !== x && (i[j] = d);
                f.attr(i)
            }
        },
        ...
        render: function () {
            ...
            n(b.series, function (a) {
                var b = a.options;
                b.showInLegend && !r(b.linkedTo) && (e = e.concat(a.legendItems || (b.legendType ===
                            "point" ? a.data : a)))
            });
            Gb(e, function (a, b) {
        ...
        scroll: function (a, b) {
            var c = this.pageCount,
                ...
                i = this.padding;
            d > c && (d = c);
            if (d > 0) b !== x && Ha(b, this.chart), this.nav.attr({
                    translateX: i,
    ...
    sb.prototype = {
        ...
        zoom: function (a) {
            ...
            !a || a.resetSelection ? n(this.axes, function (a) {
                ...
                var e = a.axis,
                    h = e.isXAxis;
                if (c[h ? "zoomX" : "zoomY"] ||
                    c[h ? "pinchX" : "pinchY"]) b = e.zoom(a.min, a.max), e.displayBtn && (d = !0)
            });
        ...
        pan: function (a) {
            ...
            b.series.length && f > K(e.dataMin, e.min) && c <
                q(e.dataMax, e.max) && b.setExtremes(f, c, !0, !1, {
                    trigger: "pan"
                });
            this.mouseDownX = a;
            L(this.container, {
        ...
        setTitle: function (a, b) {
            ...
            var c = this,
                d = c.options,
                e;
            e = d.title = y(d.title, a);
            f = d.subtitle = y(d.subtitle, b), d = f;
            n([
                    ["title", a, e],
                    ["subtitle", b, d]
                ], function (a) {
        ...
        cloneRenderTo: function (a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Ra(b), delete this.renderToClone) : (c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0),
                L(b, {
                        position: "absolute",
                        top: "-9999px",
                        display: "block"
        ...
        getContainer: function () {
            ...
            this.renderer = b.forExport ? new Aa(a, c, d, !0) : new Sa(a, c, d);
        ...
        getMargins: function () {
            ...
            if ((this.title || this.subtitle) && !r(this.optionsMarginTop))
                if (m = q(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !m.floating && !m.verticalAlign && m.y || 0)) this.plotTop = q(this.plotTop, m + o(k.margin, 15) + b);
            if (f.display && !l.floating)
                if (B === "right") {
                    if (!r(i)) this.marginRight = q(this.marginRight,
                        f.legendWidth - s + p + c)
                } else if (B === "left") {
        ...
        drawChartBox: function () {
            ...
            if (k) f ? f.animate(r) : this.plotBackground = b.rect(o, n, t, q, 0).attr({
                    fill: k
                }).add().shadow(a.plotShadow);
            if (m) h ? h.animate(r) : this.plotBGImage =
                b.image(m, o, n, t, q).add();
            v ? v.animate({
                    width: u.width,
                    height: u.height
        ...
        propFromSeries: function () {
            ...
            n(["inverted", "angular", "polar"], function (g) {
                ...
                for (e = d && d.length; !f && e--;)(c = aa[d[e].type]) && c.prototype[g] &&
                (f = !0);
                a[g] = f
            })
        },
        ...
        isReadyToRender: function () {
            var a = this;
            return !Z && O == O.top && z.readyState !==
                "complete" || $ && !O.canvg ? ($ ? Qb.push(function () {
                        a.firstRender()
        ...
        firstRender: function () {
            var a = this,
                b = a.options,
                c = a.callback;
            if (a.isReadyToRender()) a.getContainer(), D(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function (b) {
                a.initSeries(b)
            }), D(a, "beforeRender"), a.pointer = new qb(a,
                b), a.render(), a.renderer.draw(), c && c.apply(a, [a]), n(a.callbacks, function (b) {
                    b.apply(a, [a])
    ...
    Ma.prototype = {
        ...
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                    ...
                    b || n(e.getSelectedPoints(), function (a) {
                        if (a.selected &&
                            a !== c) a.selected = a.options.selected = !1, d.options.data[la(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
                    })
                })
        },
        ...
        onMouseOut: function () {
            var a = this.series.chart,
                b = a.hoverPoints;
            if (!b || la(this, b) === -1) this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint =
                null
        },
    ...
    R.prototype = {
        ...
        setOptions: function (a) {
            ...
            this.userOptions = a;
            a = y(d, c.series, a);
            this.tooltipOptions = y(b.tooltip, a.tooltip);
        ...
        generatePoints: function () {
            ...
            for (l = 0; l < g; l++) i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ha(e[l]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !== (c = b.length) || j))
                for (l = 0; l < c; l++)
                    if (l === h && !j && (l += g), b[l]) b[l].destroyElements(), b[l].plotX = x;
            this.data = b;
            this.points = m
        },
        translate: function () {
            this.processedXData ||
                this.processData();
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !! this.modifyValue, i, j = e.series, k = j.length, m = a.pointPlacement === "between", a = a.threshold; k--;)
                if (j[k].visible) {
                    j[k] === this && (i = !0);
                    break
                }
            for (k = 0; k < g; k++) {
                ...
                j.plotY = typeof p === "number" && p !== Infinity ? t(e.translate(p, 0, 1, 0, 1) * 10) / 10 : x;
        ...
        tooltipHeaderFormatter: function (a) {
            ...
            if (e && !c)
                for (g in E)
                    if (E[g] >= d.closestPointRange) {
                        c =
                            b.dateTimeLabelFormats[g];
                        break
                    }
            e && c && Ca(a.key) && (f = f.replace("{point.key}", "{point.key:" + c + "}"));
            return Ea(f, {
                    point: a,
                    series: this
                })
        ...
        drawPoints: function () {
            ...
            if (m.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g =
                        b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === x || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e) && g.y !== null)
        ...
        getAttribs: function () {
            ...
            for (g = i.length; g--;) {
                ...
                if (f) {
                    ...
                    if (h.negative && b.marker) k[""].fill = k.hover.fill = k.select.fill = a.convertAttribs({
                            fillColor: l
                        }).fill
                } else k = j;
                h.pointAttr = k
    ...
    M = ea(R, {
            ...
            getSegmentPath: function (a) {
                ...
                if (e.stacking && !this.closedStacks)
                    for (d = a.length - 1; d >= 0; d--) d < a.length - 1 && e.step && c.push(a[d +
                        1].plotX, a[d].yBottom), c.push(a[d].plotX, a[d].yBottom);
    ...
    F = ea(R, {
            ...
            getColumnMetrics: function () {
                ...
                c.grouping === !1 ? i = 1 : n(b.series, function (b) {
                    var c = b.options;
                    if (b.type === a.type && b.visible && a.options.group === c.group) c.stacking ? (f = b.stackKey, g[f] === x && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++), b.columnIndex = h
                });
            ...
            drawPoints: function () {
                ...
                n(a.points, function (e) {
                    var f = e.plotY,
                        g = e.graphic;
                    if (f !== x && !isNaN(f) && e.y !== null) d = e.shapeArgs, g ? (Ta(g), g.animate(y(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
            ...
            alignDataLabel: function (a, b, c, d, e) {
                var f = this.chart,
                    ...
                    i = a.below || a.plotY > o(this.translatedThreshold,
                        f.plotSizeY),
            ...
            animate: function (a) {
                var b = this.yAxis,
                    ...
                    e = {};
                if (Z) a ? (e.scaleY = 0.001, a = K(b.pos +
                        b.len, q(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
            },
            remove: function () {
                var a = this,
                    b = a.chart;
    ...
    W = {
        ...
        pointClass: ea(Ma, {
                ...
                setVisible: function (a) {
                    var b = this,
                        ...
                        d = c.chart,
                        e;
                    b.visible = b.options.visible = a = a === x ? !b.visible : a;
                    c.options.data[la(b,
                        c.data)] = b.options;
                    e = a ? "show" : "hide";
        ...
        translate: function (a) {
            ...
            var b = 0,
                ...
                e = d.slicedOffset,
                f = e + d.borderWidth,
                g, h, i, j = this.startAngleRad = Ja / 180 * ((d.startAngle || 0) % 360 - 90),
                k =
                    this.points,
                m = 2 * Ja,
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (H = 2; H--;) {
                    ...
                    for (C = 0; C < J; C++) {
                        ...
                        if (m > 0) {
                            if (w = L.pop(),
                                F = w.i, z = w.y, c > z && b[F + 1] !== null || c < z && b[F - 1] !== null) z = c
                        } else z = c;
                ...
                if (pa(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(), r && g && n(this.points, function (b) {
                    i =
                        b.connector;
                    u = b.labelPos;
                    if ((v = b.dataLabel) && v._pos) A = v.connX, z = v.connY, j = k ? ["M", A + (u[6] === "left" ? 5 : -5), z, "C", A, z, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), z, "L", u[2], u[3], "L", u[4], u[5]], i ? (i.animate({
                                d: j
